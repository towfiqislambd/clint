    ...
    return (
        <div className="border p-6 rounded-lg border-gray-200 shadow">
            ...
            <div className="flex  justify-between mb-4">
                <p className="font-medium text-gray-600 cursor-pointer">{category}</p>
                <p className="px-4 font-medium cursor-pointer py-2 rounded-full text-sm bg-purple-200">{status}</p>
            </div>
