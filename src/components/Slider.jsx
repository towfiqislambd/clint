        ...
        <div className="carousel w-full h-[550px] relative overflow-hidden">
            <div id="slide1" className="carousel-item h-full relative w-full">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white space-y-6 px-5">
                    ...
                    {/* <h1 className="text-3xl w-2/3 mx-auto md:text-4xl tracking-wide lg:text-5xl lg:leading-[3.5rem] font-semibold">Empowering dreams, your platform for crowdfunding success</h1> */}
