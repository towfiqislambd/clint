        ...
        <div className="container mx-auto px-5">
            <div className="bg-purple-100 mx-auto shadow-lg border-purple-200 border rounded-lg max-w-[26rem] my-8">
                <form onSubmit={handleRegister} className="px-8 p-5 pb-3 ">
                    ...
                    <p className="text-gray-700 text-center pt-3 pb-4">Already have an account? <Link to="/login" className="link link-hover text-purple-600 font-semibold">Login</Link></p>
                </form>
                {
